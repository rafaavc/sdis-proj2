...
//    private final MyFileInfo info;
//    private final StoredTracker storedTracker;
//    private final CompletableFuture<Result> future;
//
//    public ChunksBackup(InetSocketAddress destination, SSLClient client, CompletableFuture<Result> future, StoredTracker storedTracker, PeerConfiguration configuration, MyFileInfo info, Map<Chunk, byte[]> chunksToSend) throws Exception {
...
//    }
//
//    private ChunksBackup(InetSocketAddress destination, SSLClient client, CompletableFuture<Result> future, StoredTracker storedTracker, PeerConfiguration configuration, MyFileInfo info, Map<Chunk, byte[]> chunksToSend, int count, int sleepAmount) throws Exception {
