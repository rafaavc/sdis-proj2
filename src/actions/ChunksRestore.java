...
//
//    public ChunksRestore(CompletableFuture<Result> future, PeerConfiguration configuration, MyFileInfo info, Map<ChunkPair, byte[]> chunksToGet) {
//        this.count = 1;
...
//    }
//
//    private ChunksRestore(CompletableFuture<Result> future, PeerConfiguration configuration, MyFileInfo info, Map<ChunkPair, byte[]> chunksToGet, int count, int sleepAmount) {
...
//            {
//                if (chunkTracker.hasReceivedChunk(info.getFileKey(), chunk.getChunkNo())) continue;
