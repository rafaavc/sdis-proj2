...
//    private final OthersFileInfo chunk;
//    private int count, sleepAmount;
//    private final PeerConfiguration configuration;
//    private final byte[] putchunkMsg, storedMsg;
//    private final StoredTracker storedTracker;
//
//    public ReclaimChunkBackup(StoredTracker storedTracker, PeerConfiguration configuration, OthersFileInfo chunk, byte[] putchunkMsg, byte[] storedMsg) {
//        this.count = 1;
...
//    }
//
//    private ReclaimChunkBackup(StoredTracker storedTracker, PeerConfiguration configuration, OthersFileInfo chunk, byte[] putchunkMsg, byte[] storedMsg, int count, int sleepAmount) {
...
//                    @Override
//                    public void run() {
//                        int replicationDegree = storedTracker.getStoredCount(chunk.getFileKey(), chunk.getChunkNo());
//
